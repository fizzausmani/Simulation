...
pos0 = np.load('C:\\Users\\fusmani\\Box\\Research\\Python\\Full Results\\SP16\\2\\FM MP T1000 SP16 sd1000 pos.npy')[:,:,0]
p0 = np.load('C:\\Users\\fusmani\\Box\\Research\\Python\\Full Results\\SP16\\2\\FM MP T1000 SP16 sd1000 p.npy')[:,:,0]
save_path = 'C:\\Users\\fusmani\\Box\\Research\\Python\\Full Results\\SP16\\2\\'
...
for n in range(0, steps):
    ...
    p_particle = dp_particle(ux, uy, pos[:,:,n], p[:,:,n])
    ...
    p_particle_temp = dp_particle(ux_temp, uy_temp, temp_pos, temp_p)
